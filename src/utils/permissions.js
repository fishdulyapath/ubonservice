const PERMISSIONS = [
  ...
  { key: 'product.price_check.view', label: 'เช็คราคาสินค้า: เข้าหน้าจอ' },
  ...
  { key: 'sales.return.cash_history.view', label: 'ประวัติรับคืน/ลดหนี้: เข้าหน้าจอ' },
  ...
  { key: 'product.sale_price', label: 'จัดการสินค้า: ดูราคาขาย/โปรโมชั่น' },
  { key: 'product.sale_price.edit', label: 'จัดการสินค้า: แก้ไขราคาขาย/โปรโมชั่น' },
  { key: 'product.discount', label: 'จัดการสินค้า: ดูเงื่อนไขส่วนลด' },
  { key: 'product.discount.edit', label: 'จัดการสินค้า: แก้ไขเงื่อนไขส่วนลด' },
